   ...
   <body>
      <div class="login-form">
         <form action="" method="post">
            <h2 class="text-center">Odiseo admin</h2>
            <div class="form-group">
               <input type="text" class="form-control" placeholder="Usuario" required="required" id="nombreUsuario" name="nombreUsuario">
            </div>
            <div class="form-group">
               <input type="password" class="form-control" placeholder="Password" required="required" id="passUsuario" name="passUsuario">
            </div>
            <div class="form-group">
               <button type="button" class="btn btn-primary btn-block" onclick="LoginAcc()">Entrar</button>
            </div>
            <div class="clearfix">
